...
import { INotificationContext, NotificationContext } from "../context/NotificationContext";
...
export const useNotification = (): [INotificationContext, INotificationActions] => {
	...
	const showNotification = (message: string, success: boolean) => {
		...
		setTimeout(() => {
			notification.setType(success ? SUCCESS_NOTIFICATION : ERROR_NOTIFICATION);
