...
function getLaunchs(): ILaunchDto[] {
	return [
...
function createLaunch(createLaunchDto: ICreateLaunchDto): void {
	console.log(createLaunchDto);
}

function updateLaunch(launchId: number | undefined, updateLaunchDto: IUpdateLaunchDto): void {
	console.log(launchId, updateLaunchDto);
}

function deleteLaunch(launchId: number): void {
